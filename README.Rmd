...
The `cpp11poppler` package provides a set of functions for extracting text,
fonts, attachments and metadata from a PDF file. It is a fork of `pdftools` that
uses `cpp11` for those that require it for licensing or security purposes.
